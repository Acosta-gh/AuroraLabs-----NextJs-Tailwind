...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function bt(a10) {
        let { pathname: b2, search: c2 } = a10.nextUrl;
        if (b2.includes("//")) {
          let d2 = new URL(b2.replace(/\/+/g, "/") + c2, a10.nextUrl.origin);
          return S.redirect(d2, { status: 308 });
        }
        return S.next();
      }
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$"] }];

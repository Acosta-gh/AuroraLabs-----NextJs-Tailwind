...
## Mission
Create implementation-ready, token-driven UI guidance for AuroraLabs that is optimized for consistency, accessibility, and fast delivery across documentation site.
...
- Include known page component density: links (32), buttons (26), lists (5), navigation (2).
